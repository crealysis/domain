  ...
  return (
    <header className="fixed top-0 w-full bg-white border-b border-gray-200 z-50 h-20">
      <nav className="max-w-7xl mx-auto px-8 flex justify-between items-center h-full">
        ...
        {/* Action Buttons - Hidden on small screens, visible on large screens */}
      ...
      <div
        className={`lg:hidden fixed top-20 left-0 w-full bg-white transition-transform duration-300 ease-in-out ${
